...
public final class FilePathConfig {
     ...
     * 扩展功能的输入源代码
     */
    public static final String SRC_CODE_MOREFUNC_PATH = "data/in/input_code_advanced.txt";
     ...
     * 词法单元流 - 扩展功能
     */
    public static final String TOKEN_MOREFUNC_PATH = "data/out_advanced/token.txt";
     ...
     * 语义分析前的符号表 - 扩展功能
     */
    public static final String OLD_SYMBOL_TABLE_MOREFUNC = "data/out_advanced/old_symbol_table.txt";
     ...
     * 规约出的产生式列表 - 扩展功能
     */
    public static final String PARSER_MOREFUNC_PATH = "data/out_advanced/parser_list.txt";
